...
public partial class AlbumUploadaspx : System.Web.UI.Page
{
        ...
        if (pic_upload.HasFile)//验证是否包含文件
        {
            ...
            if (fileOk)
            {
                ...
                if (pic_upload.PostedFile.ContentLength < 8192000)
                {
                    ...
                    string sql = "insert into Album(userid,albumid,time,image) values(@";
                    //显示图片
                    string[] column = new string[4] {"userid14","albumid","time4","virpath"};
                    string[] columnvalue = new string[4] {userID,albumid,time,virpath};
