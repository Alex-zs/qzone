<%@ Page Title="" Language="C#" MasterPageFile="~/VisitFriend.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="FriendQzone.aspx.cs" Inherits="FriendQzone" %>
     ...
     <asp:Repeater ID="talklist" runat="server" OnItemCommand="talklist_ItemCommand" OnItemDataBound="talklist_ItemDataBound">
           ...
           <h2>   <asp:Image ID="userhead" runat="server" Width="50px" Height="50px" ImageUrl ='<%# Eval("picture") %>' />
            ...
            <ContentTemplate>
                ...
                <asp:Button ID="submit" runat="server" Text="发表" OnClick="submit_Click1" Visible="false" />
