...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <asp:Button ID="creatAlbum" Text="创建相册" runat="server" OnClick="creatAlbum_Click" />
    <br />
    <h2>相册</h2>
    <asp:Repeater ID="album" runat="server" OnItemCommand="album_ItemCommand">
        <ItemTemplate>
         ...
         <h4><asp:LinkButton ID="albumName" runat="server" Text='<%# Eval("albumName") %>' PostBackUrl='<%# "PhotoList.aspx?id="+Eval("id") %>'  CommandName="albumName" CommandArgument='<%# Eval("id") %>'></asp:LinkButton>
        </h4>
